...
export function FooterDefault() {
  const { name, address, phone, email, social, rating, totalReviews, schedule } = dentistConfig;
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-3 flex items-center gap-2">
              ...
              <span className="text-sm text-muted">{rating} ({totalReviews})</span>
            </div>
            <p className="mt-3 text-sm text-muted">
              {dentistConfig.about.description.slice(0, 120)}...
            </p>
          </div>
          ...
          <div>
            <h4 className="mb-4 font-bold text-on-primary">Síguenos</h4>
            <div className="flex gap-3">
              {social?.facebook && (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-brand border border-white/10 text-muted transition-colors hover:border-secondary hover:text-secondary"
                  aria-label="Facebook"
                >
            ...
            <div className="mt-6">
              <h4 className="mb-2 text-sm font-bold text-on-primary">Servicios</h4>
              <div className="space-y-1">
                {dentistConfig.services.slice(0, 4).map((s) => (
